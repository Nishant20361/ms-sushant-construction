...
export default function AboutScreen() {
  ...
  const destination = settings?.businessAddress?.trim() || settings?.address?.trim() || "";
  const directionsUrl = businessDirectionsUrl(settings);
