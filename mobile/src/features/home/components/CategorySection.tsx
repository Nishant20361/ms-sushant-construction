...
const styles = StyleSheet.create({ section: { marginTop: 28 }, list: { gap: CATEGORY_GAP, paddingTop: 14, paddingRight: 16 }, card: { height: 122, flexGrow: 0, flexShrink: 0, alignItems: "center", paddingTop: 7, borderWidth: 1, borderColor: "#D5E9E4", borderRadius: 18, backgroundColor: theme.colors.surface, ...theme.shadow }, pressed: { opacity: 0.72, transform: [{ scale: 0.98 }] }, iconCircle: { width: 50, height: 50, overflow: "hidden", alignItems: "center", justifyContent: "center", borderRadius: 15, backgroundColor: "#CCFBF1" }, categoryImage: { width: 50, height: 50 }, icon: { fontSize: 23, color: theme.colors.primaryDark }, nameRegion: { alignSelf: "stretch", height: 32, marginTop: 4, justifyContent: "center", overflow: "hidden" }, name: { textAlign: "center", fontSize: 10.5, lineHeight: 16, fontWeight: "700", color: theme.colors.text }, count: { alignSelf: "stretch", height: 16, marginTop: 2, textAlign: "center", fontSize: 10, lineHeight: 16, color: theme.colors.muted }, skeleton: { height: 122, alignItems: "center", paddingTop: 7, borderRadius: 18, backgroundColor: theme.colors.surface }, skeletonIcon: { width: 50, height: 50, borderRadius: 15, backgroundColor: theme.colors.border }, skeletonLine: { width: 58, height: 11, marginTop: 10, borderRadius: 6, backgroundColor: theme.colors.border }, error: { minHeight: 72, marginTop: 14, justifyContent: "center", padding: 14, borderRadius: 12, backgroundColor: "#FEF2F2" }, errorTitle: { color: theme.colors.danger, fontWeight: "700" }, retry: { marginTop: 3, color: theme.colors.primary, fontWeight: "700" }, empty: { marginTop: 14, color: theme.colors.muted } });
