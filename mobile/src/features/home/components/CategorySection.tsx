...
const styles = StyleSheet.create({ section: { marginTop: 28 }, list: { gap: 12, paddingTop: 14, paddingRight: 16 }, card: { width: 132, height: 132, padding: 13, borderWidth: 1, borderColor: "#D5E9E4", borderRadius: 18, backgroundColor: theme.colors.surface, ...theme.shadow }, pressed: { opacity: 0.72, transform: [{ scale: 0.98 }] }, iconCircle: { width: 48, height: 48, overflow: "hidden", alignItems: "center", justifyContent: "center", borderRadius: 15, backgroundColor: "#CCFBF1" }, categoryImage: { width: 48, height: 48 }, icon: { fontSize: 24, color: theme.colors.primaryDark }, name: { height: 36, marginTop: 8, fontSize: 13, lineHeight: 17, fontWeight: "800", color: theme.colors.text }, count: { height: 15, marginTop: 2, fontSize: 11, lineHeight: 15, color: theme.colors.muted }, skeleton: { width: 132, height: 132, padding: 13, borderRadius: 18, backgroundColor: theme.colors.surface }, skeletonIcon: { width: 48, height: 48, borderRadius: 15, backgroundColor: theme.colors.border }, skeletonLine: { width: 92, height: 12, marginTop: 12, borderRadius: 6, backgroundColor: theme.colors.border }, error: { minHeight: 72, marginTop: 14, justifyContent: "center", padding: 14, borderRadius: 12, backgroundColor: "#FEF2F2" }, errorTitle: { color: theme.colors.danger, fontWeight: "700" }, retry: { marginTop: 3, color: theme.colors.primary, fontWeight: "700" }, empty: { marginTop: 14, color: theme.colors.muted } });
