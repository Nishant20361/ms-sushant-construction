...
const styles = StyleSheet.create({ section: { marginTop: 28 }, list: { gap: 12, paddingTop: 14, paddingRight: 16 }, card: { width: 136, height: 150, alignItems: "center", paddingHorizontal: 8, paddingTop: 12, borderWidth: 1, borderColor: "#D5E9E4", borderRadius: 18, backgroundColor: theme.colors.surface, ...theme.shadow }, pressed: { opacity: 0.72, transform: [{ scale: 0.98 }] }, iconCircle: { width: 54, height: 54, overflow: "hidden", alignItems: "center", justifyContent: "center", borderRadius: 16, backgroundColor: "#CCFBF1" }, categoryImage: { width: 54, height: 54 }, icon: { fontSize: 25, color: theme.colors.primaryDark }, nameRegion: { width: "100%", height: 42, marginTop: 6, justifyContent: "center" }, name: { width: "100%", textAlign: "center", fontSize: 13, lineHeight: 19, fontWeight: "800", color: theme.colors.text }, count: { width: "100%", height: 18, marginTop: 3, textAlign: "center", fontSize: 11, lineHeight: 18, color: theme.colors.muted }, skeleton: { width: 136, height: 150, alignItems: "center", paddingTop: 12, borderRadius: 18, backgroundColor: theme.colors.surface }, skeletonIcon: { width: 54, height: 54, borderRadius: 16, backgroundColor: theme.colors.border }, skeletonLine: { width: 100, height: 12, marginTop: 12, borderRadius: 6, backgroundColor: theme.colors.border }, error: { minHeight: 72, marginTop: 14, justifyContent: "center", padding: 14, borderRadius: 12, backgroundColor: "#FEF2F2" }, errorTitle: { color: theme.colors.danger, fontWeight: "700" }, retry: { marginTop: 3, color: theme.colors.primary, fontWeight: "700" }, empty: { marginTop: 14, color: theme.colors.muted } });
